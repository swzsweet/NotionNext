const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-09-01', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.shiwz.com' },
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '自留地',
  HERO_TITLE_2: '随便发发',
  HERO_TITLE_3: 'blog.shiwz.com',
  HERO_TITLE_4: '推荐',
  HERO_TITLE_5: '京东羊毛上车入口',
  HERO_TITLE_LINK: 'http://ck.shiwz.com',
  ...
  GROUP_ICONS: [
    {
      title_1: 'Figma',
      img_1: 'https://play.google.com/store/apps/details?id=com.figma.mirror&hl=zh',
      color_1: '#57b6e6',
      title_2: 'Axure',
      img_2: 'https://play.google.com/store/apps/details?id=com.figma.mirror&hl=zh',
      color_2: '#4082c3'
    },
    {
      title_1: 'Docker',
